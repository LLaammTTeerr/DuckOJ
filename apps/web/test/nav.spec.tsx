...
describe('the desktop bar groups what used to be one flat row', () => {
  ...
  it('keeps the way out, the name, the bell and the language on the bar', async () => {
    ...
    // D139 collapsed the five account PAGES behind an overflow button — but
  ...
  it('collapses the five account pages and the theme behind one overflow button (D139)', async () => {
    serve(STUDENT);
    renderShell();
