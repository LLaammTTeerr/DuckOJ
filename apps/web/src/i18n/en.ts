...
export const en = {
  ...
  'common.stale': 'Not updated since {time} — the connection may be down.',
  'common.serverSaid': 'The server said: {detail}',
  ...
  'problems.empty': 'No problems have been published yet.',
  'problems.emptyAction': 'Read the guide',
  'problems.emptyFiltered': 'No problem matches these filters.',
  ...
  'problem.sampleN': 'Sample {n}',
  'problem.sampleInput': 'Input',
  'problem.sampleOutput': 'Output',
  'problem.sampleCopy': 'Copy',
  'problem.sampleCopied': 'Copied',
  'problem.sampleTruncated': 'truncated',
  ...
  'discussion.replyLabel': 'Reply',
  'discussion.editLabel': 'Edit comment',
  ...
  'revisions.uploadFailed': 'The package could not be uploaded.',
  'revisions.attachFailed': 'The package could not be attached to this problem.',
  'revisions.publishFailed': 'This revision could not be published.',
  ...
  'contests.filterPhase': 'Phase',
  'contests.phaseAny': 'All',
  'contests.phaseActive': 'not finished',
  'contests.emptyForPhase': 'No contests in this phase.',
  'contests.empty': 'No contest has been scheduled yet.',
  'contests.emptyAction': 'Practise on the problem set',
  ...
  'contest.clone': 'Clone this contest',
  ...
  'contestNew.cloneOrgs': 'Organizations that may enter: {list}',
  'contestNew.cloneOrgsNone': 'no restriction',
  ...
  'org.members': 'Members',
  'org.searchMembers': 'Find a member',
  'org.searchMembersHint': 'name or account, accents optional',
  'org.noMemberMatch': 'Nobody in this organization matches “{q}”.',
  ...
  'admin.findUser': 'Find an account',
  'admin.findHint': 'name or account, accents optional',
  'admin.findPick': '{name} ({username}) — {role}',
  'admin.findNone': 'No account matches “{q}”.',
  'admin.findMore': 'More match than are shown — type more of the name.',
  'admin.findError': 'Accounts could not be searched.',
  ...
  'testData.explanation': 'Sample explanation (optional)',
  'testData.explanationFor': 'Explanation for sample {n}',
  ...
  // ── the contest-day monitor (D95) ──────────────────────────────────────
  'contest.monitor': 'Live monitor',
  'monitor.title': 'Live monitor',
  'monitor.subtitle': 'Only the people who run this contest can see this page.',
  'monitor.updated': 'As of {time}',
  'monitor.pollOnly': 'live updates unavailable, refreshing every 5 s',
  'monitor.loadError': 'Could not load the monitor.',
  'monitor.online': 'Competitors connected',
  'monitor.queueDepth': 'Waiting to be judged',
  'monitor.queueOldest': 'Oldest wait',
  'monitor.judges': 'Judges up',
  ...
  'monitor.problemsHeading': 'Problems',
  'monitor.noProblems': 'This contest has no problems yet.',
  'monitor.colProblem': 'Problem',
  'monitor.colSubmitted': 'Attempts',
  'monitor.colAccepted': 'Accepted',
  'monitor.colSolvers': 'Solvers',
  'monitor.colPending': 'Judging',
  'monitor.colProgress': 'Pass rate',
  'monitor.barLabel': '{accepted} of {submitted} attempts accepted',
  'monitor.feedHeading': 'Latest submissions',
  'monitor.feedNote': 'The last fifty, with real verdicts — the freeze hides nothing from you.',
  'monitor.noFeed': 'Nobody has submitted yet.',
  'monitor.colTime': 'Time',
  'monitor.colVerdict': 'Verdict',
  'monitor.grading': 'judging',
  'monitor.clarificationsHeading': 'Questions waiting',
  'monitor.noClarifications': 'No unanswered questions.',
  'monitor.colQuestion': 'Question',
  'monitor.wholeContest': 'the contest',
  'monitor.answerThere': 'Answer on the contest page',
  // ── teams, "đội tuyển" (D99) ───────────────────────────────────────────
  'teams.title': 'Teams',
  'teams.empty': 'No teams yet.',
  'teams.colTeam': 'Team',
  'teams.colMembers': 'Members',
  'teams.noMembers': 'nobody yet',
  'teams.new': 'Assemble a team',
  'teams.edit': 'Edit',
  'teams.delete': 'Disband',
  'teams.deleteError': 'Could not disband the team.',
  'teams.slug': 'Slug',
  'teams.name': 'Name',
  'teams.members': 'Members',
  'teams.pickMember': 'Find a pupil to add',
  'teams.pickAdd': 'Add {name} ({username})',
  'teams.pickMore': 'More match than are shown — type more of the name.',
  'teams.pickError': 'The roster could not be searched.',
  'teams.membersHint':
  ...
  'teams.noContests': 'This team has not entered a contest yet.',
  'teams.colContest': 'Contest',
  'teams.colWhen': 'Started',
  'teams.colEntry': 'Entered by',
  'teams.colResults': 'Results',
  'teams.running': 'running now',
  'teams.disqualified': 'disqualified',
  'teams.scoreboard': 'Scoreboard',
  'teams.listError': "Could not read this school's teams.",
  'teams.loadError': 'Could not read this team.',
  'contest.teamReason.contest_not_team_mode': 'this contest is individual',
  'contest.teamReason.contest_team_org_not_named': 'this contest is not for that school',
  'contest.teamReason.contest_team_too_large': 'too many members for this contest',
  'contest.teamReason.contest_team_joined': 'already entered',
  'contest.teamReason.contest_already_joined': 'somebody on it is already competing',
  'contest.teamReason.contest_team_name_taken': 'another team of that name is competing',
  ...
  'contest.modeTeam': 'Team',
  'contest.maxTeamSize': 'Members per team',
  'contest.maxTeamSizeHint': 'Only used by a team contest. Three is the ICPC roster.',
  'scoreboard.teamMembers': 'Members: {members}',
