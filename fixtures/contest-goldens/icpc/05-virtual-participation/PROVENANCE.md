# Provenance — `icpc/05-virtual-participation`

A virtual participation among live ones.

## What this scenario pins down

- icpc inherits default's first-solve rule verbatim: virtuals are counted in total_ac but can never be the first solver.
...
| Command | `fixtures/contest-goldens/_generator/run.sh --only icpc/05-virtual-participation` |
| Verified with | `fixtures/contest-goldens/_generator/run.sh --verify --only icpc/05-virtual-participation` |
| Date | 2026-08-21 |
...
Perturbation: alice's accept moves 40 minutes later, handing the first solve to bob.
...
| `ranking[1].cumtime` | `40` | `70` |
| `ranking[1].format_data.a.time` | `2400.0` | `4200.0` |
| `ranking[1].frozen_cumtime` | `40` | `70` |
| `ranking[1].frozen_tiebreaker` | `40.0` | `70.0` |
| `ranking[1].participant` | `alice` | `bob` |
| `ranking[1].tiebreaker` | `40.0` | `70.0` |
| `ranking[2].cumtime` | `70` | `80` |
| `ranking[2].format_data.a.time` | `4200.0` | `4800.0` |
| `ranking[2].frozen_cumtime` | `70` | `80` |
| `ranking[2].frozen_tiebreaker` | `70.0` | `80.0` |
| `ranking[2].participant` | `bob` | `alice` |
| `ranking[2].tiebreaker` | `70.0` | `80.0` |
